...
from .container_resolvers.mirror import MirrorResolver
from .container_resolvers.mirrored_mulled import MirroredMulledDockerContainerResolver
...
#        return plugin_config.plugins_dict(container_resolvers, "resolver_type")
    ...
    def __resolvers_dict(self) -> Dict[str, Type["ContainerResolver"]]:
        resolvers_map = plugin_config.plugins_dict(container_resolvers, "resolver_type")
        # ensure your types exist even if package scanning misses them
        resolvers_map.update({
          "mirror": MirrorResolver,
          "mirrored_mulled": MirroredMulledDockerContainerResolver,
        })
        return resolvers_map
